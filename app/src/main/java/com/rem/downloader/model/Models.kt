...
// Lightweight info about a single entry in a multi-video post
...
data class VideoInfo(
    ...
    val videoCount: Int = 1,      // >1 for carousels / multi-video posts
...
data class DownloadOptions(
    ...
    val playlistIndex: Int = 0    // 1-based index into a multi-video post; 0 = no specific index
)
